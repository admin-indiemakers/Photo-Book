...
const SIZES = [
  ...
  { id: '3.5x3.5', label: '3.5 x 3.5 inches', dimensions: '3.5 x 3.5 inches', price: 199, ratio: 'aspect-[3.5/3.5]' },
  { id: '3x4', label: '3 x 4 inches', dimensions: '3 x 4 inches', price: 199, ratio: 'aspect-[3/4]' },
  { id: '4x6', label: '4 x 6 inches', dimensions: '4 x 6 inches', price: 249, ratio: 'aspect-[4/6]' }
];
...
export const FridgeMagnetProductPage = () => {
  ...
  const updateItemCaption = (id: string, newCaption: string) => {
    setMagnetItems(prev => prev.map(item => item.id === id ? { ...item, caption: newCaption } : item));
  };

  const updateItemFont = (id: string, newFontId: string) => {
    setMagnetItems(prev => prev.map(item => item.id === id ? { ...item, fontId: newFontId } : item));
  };
          ...
          {magnetItems.length === 0 && (
            ...
            >
              ...
              <div className="bg-white/60 p-4 rounded-xl border border-black/5 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="text-sm font-medium text-[#1a1a18]">2.5x3 to 4x6 inches</div>
                <div className="text-xs text-[#6b6560] mt-1">4 different sizes to choose from</div>
              </div>
              ...
              <div className="bg-white/60 p-4 rounded-xl border border-black/5 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="text-sm font-medium text-[#1a1a18]">₹189.00</div>
          ...
          <div className="space-y-8">
            ...
            {magnetItems.length > 0 && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
                ...
                <div className="space-y-3 max-h-none lg:max-h-[400px] overflow-visible lg:overflow-y-auto pr-0 lg:pr-2 scrollbar-hide">
                  <AnimatePresence>
            ...
            >
              ...
              >
                ...
                >
                  <motion.div 
                    layout
                    className={`bg-[#e5e5e5] overflow-hidden relative w-64 sm:w-72 md:w-80 shadow-inner rounded-md ${activeSize?.ratio || 'aspect-square'}`}
                  >
                  ...
                  {/* Caption Area */}
                  <div className="mt-3 text-center w-full px-2 h-8 flex items-center justify-center overflow-hidden">
                    <AnimatePresence mode="wait">
                      <motion.p
