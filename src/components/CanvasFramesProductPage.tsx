...
const SIZES = [
  { id: 'portrait', label: 'Portrait', dimensions: 'Portrait', price: 699 },
  { id: 'landscape', label: 'Landscape', dimensions: 'Landscape', price: 699 },
  { id: 'square', label: 'Square', dimensions: 'Square', price: 699 }
];
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-20 pt-8 flex flex-col lg:flex-row gap-16 relative">
        ...
        <div className="flex-1 w-full space-y-10 relative z-10">
          <div>
            ...
            >
              Gallery-quality canvas prints to turn your photos into timeless art pieces.
            </motion.p>
          </div>
        ...
        >
          ...
          >
            ...
            >
              <motion.div 
                layout
                className={`transition-all duration-500 shadow-2xl relative bg-white border-8 border-gray-100 overflow-hidden w-64 sm:w-72 md:w-80 ${getAspectRatioClass(activeSize?.id)}`}
                style={{
                  boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.4), inset 0 0 0 1px rgba(0,0,0,0.1), 0 0 0 10px #f3f4f6'
                }}
              >
                {/* Canvas Texture Overlay */}
                <div 
                  className="absolute inset-0 z-20 pointer-events-none opacity-[0.15] mix-blend-multiply"
                  style={{ backgroundImage: 'url("data:image/svg+xml,%3Csvg viewBox=\'0 0 200 200\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cfilter id=\'noiseFilter\'%3E%3CfeTurbulence type=\'fractalNoise\' baseFrequency=\'0.85\' numOctaves=\'3\' stitchTiles=\'stitch\'/%3E%3C/filter%3E%3Crect width=\'100%25\' height=\'100%25\' filter=\'url(%23noiseFilter)\'/%3E%3C/svg%3E")' }}
                ></div>
                  ...
                  <AnimatePresence mode="wait">
                    {activeItem ? (
                      ...
                      >
                        ...
                        <span className="font-mono text-[10px] uppercase tracking-widest opacity-50 text-center">Empty<br/>Canvas</span>
                      </motion.div>
                    )}
                  </AnimatePresence>
                </div>
