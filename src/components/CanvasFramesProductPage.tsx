      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-20 pt-8 flex flex-col lg:flex-row gap-16 relative">
        ...
        <div className="flex-1 w-full space-y-10 relative z-10">
          <div>
            ...
            >
              Bring your photos to life with our beautifully textured canvas prints. Hand-stretched and gallery-wrapped for a timeless, elegant aesthetic.
            </motion.p>
            ...
            >
              ...
              <div className="w-full h-[40%] flex gap-4">
                <div className="flex-1 rounded-2xl overflow-hidden bg-black/5 shadow-sm border border-black/5">
                  <img src={canvas2.src} alt="Frame detail" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                </div>
                <div className="flex-1 rounded-2xl overflow-hidden bg-black/5 shadow-sm border border-black/5">
                  <img src={canvas3.src} alt="Frame lifestyle" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                </div>
              </div>
            </motion.div>
          ) : (
