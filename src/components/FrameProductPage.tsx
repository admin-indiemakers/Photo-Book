    ...
    try {
      ...
      for (const item of frameItems) {
        ...
        const customOptions = {
          items: [item],
          size: item.sizeId,
          frameStyle: item.frameStyleId || 'Classic Black',
        };
          ...
          <div className="space-y-10">
            ...
            {frameItems.length > 0 && (
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
                ...
                <div className="space-y-4 max-h-none lg:max-h-[500px] overflow-visible lg:overflow-y-auto pr-0 lg:pr-2 scrollbar-hide">
                  <AnimatePresence>
                    {frameItems.map((item) => {
